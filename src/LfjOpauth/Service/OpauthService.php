...
class OpauthService implements ServiceLocatorAwareInterface
{
    ...
    public function getOptions($provider)
    {
        ...
        $this->options['path'] = $this->getRouter()->assemble(array(), array('name' => 'lfjopauth_login'));
        $this->options['callback_url'] = $this->getRouter()->assemble(array('provider' => $provider), array('name' => 'lfjopauth_callback'));
